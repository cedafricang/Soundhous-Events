...
export default function LoginPage() {
  ...
  if (data.code === 'NO_PASSWORD') {
    setError('An account exists for this email but no password has been set. Please sign up to activate your account — your points and purchase history are already waiting.')
  } else {
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Error */}
            {error && (
  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '13px 16px', border: '1px solid rgba(220,80,80,0.25)', borderRadius: 2, background: 'rgba(220,80,80,0.06)', marginBottom: 24 }}>
    ...
    <div>
      <p style={{ fontFamily: 'DM Sans', fontSize: 13, color: 'rgba(220,80,80,0.85)', lineHeight: 1.5, marginBottom: error.includes('sign up') ? 8 : 0 }}>
        {error}
      </p>
      {error.includes('sign up') && (
        <a href="/signup" style={{ fontFamily: 'DM Sans', fontSize: 12, color: '#C5855A', textDecoration: 'none', fontWeight: 500 }}>
